...
def test_bots_1_and_2_no_longer_fail_closed_on_history(bot):
    """Bots 1 and 2 must now evaluate rather than report DATA_UNAVAILABLE."""
...
def test_all_six_bots_can_evaluate():
    ...
    for bot in STRATEGY_BINDINGS:
        ...
        assert "authentic bar/VIX state unavailable" not in sig.reason, f"{bot} still blocked"
