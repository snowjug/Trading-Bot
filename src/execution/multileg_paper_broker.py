"""
Multi-leg paper execution broker for Bots 1, 2, 6 and 7.

Separate from `paper_engine.PaperExecutionEngine`, which remains in place and
unchanged: that one handles single-instrument equity-style fills, this one handles
multi-leg option structures with per-leg identity and quote gating.
...
logger = setup_logging("execution.multileg_paper_broker")
